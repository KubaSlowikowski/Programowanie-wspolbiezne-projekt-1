...
public class ParallelStreamExample {
    ...
    public static void main(String[] args) {
        ...
        list.stream()
                .map(x -> x * 2)
                .filter(x -> x > 1)
                .map(doer::doHeavyWork)
                .forEach(x1 -> System.out.println("sequential: " + x1 + " " + Thread.currentThread().getName()));
        ...
        list.parallelStream()
                ...
                .filter(x -> x > 1)
                .map(doer::doHeavyWork)
                .forEach(x1 -> System.out.println("parallel: " + x1 + " " + Thread.currentThread().getName()));
